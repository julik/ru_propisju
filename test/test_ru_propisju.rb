...
class TestRuPropisju < Test::Unit::TestCase
  ...
  def test_ints
     ...
     assert_equal "двадцать пять колес", RuPropisju.propisju_items(25, 3, "колесо", "колеса", "колес")
     assert_equal "двадцать одна подстава", RuPropisju.propisju_items(21, 2, "подстава", "подставы", "подстав")    
   end
   ...
   def test_floats
     ...
     assert_equal "двести двенадцать целых четыре десятых сволочи", RuPropisju.propisju_items(212.40, 2, "сволочь", "сволочи", "сволочей")
     assert_equal "двести двенадцать сволочей", RuPropisju.propisju_items(212.00, 2, "сволочь", "сволочи", "сволочей")
   end
